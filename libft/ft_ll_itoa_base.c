...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/01/12 12:19:03 by afaure            #+#    #+#             */
/*   Updated: 2021/08/17 00:11:44 by afaure           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "libft.h"

static int	length(unsigned long long nbr, int base_len)
{
	int	ret;
...
static void	ft_recur(int length, unsigned long long nbr, char *base, char *ret)
{
	size_t		base_len;
